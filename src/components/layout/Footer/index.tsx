...
const Footer = () => {
  return (
    <footer className="flex flex-col lg:flex-row justify-between bg-orange-500 px-8 lg:px-32 py-10">
      <div className="flex flex-col gap-5">
        <span className="text-white text-3xl font-semibold whitespace-nowrap dark:text-white">
          DIMATA
        </span>
        <span className="text-white text-lg dark:text-white lg:w-[25rem]">
          Jl. Danau Tempe No.21A, Sidakarya, Denpasar Selatan, Kota Denpasar,
          Bali 80224
        </span>
        <div className="flex flex-col">
          <span className="text-white text-xl font-semibold whitespace-nowrap dark:text-white">
            Contact Us
          </span>
          <span className="text-white text-lg dark:text-white">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-4">
            ...
            <Link href="https://www.linkedin.com" passHref>
              <span className="cursor-pointer text-white hover:text-blue-800">
                <FaLinkedin size={35} />
              </span>
            </Link>
            <Link href="https://www.instagram.com" passHref>
              <span className="cursor-pointer text-white hover:text-pink-500">
                <FaInstagram size={35} />
              </span>
            </Link>
          </div>
